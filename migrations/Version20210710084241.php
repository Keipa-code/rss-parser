 ...
 */
final class Version20210710084241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE news_item (id INT NOT NULL, title VARCHAR(3000) NOT NULL, link VARCHAR(255) NOT NULL, description VARCHAR(3000) NOT NULL, guid VARCHAR(255) NOT NULL, pub_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, author VARCHAR(3000) DEFAULT NULL, enclosure JSON DEFAULT NULL, PRIMARY KEY(id))');
